...
RqlQueryPrinter = (function() {
  ...
  composeCarrots = function(term, frames) {
    var arg, argNum, args, i, key, optargs, _i, _len, _ref;
    argNum = frames.shift();
    if (argNum == null) {
      argNum = -1;
    }
    ...
    optargs = {};
    _ref = term.optargs;
    for (arg = _i = 0, _len = _ref.length; _i < _len; arg = ++_i) {
      key = _ref[arg];
...
/**
 * Gets the value of the noreply field.
 * @return {?boolean} The value.
 */
Query.prototype.getNoreply = function() {
  return /** @type {?boolean} */ (this.get$Value(4));
};


/**
 * Gets the value of the noreply field or the default value if not set.
 * @return {boolean} The value.
 */
Query.prototype.getNoreplyOrDefault = function() {
  return /** @type {boolean} */ (this.get$ValueOrDefault(4));
};


/**
 * Sets the value of the noreply field.
 * @param {boolean} value The value.
 */
Query.prototype.setNoreply = function(value) {
  this.set$Value(4, value);
};


/**
 * @return {boolean} Whether the noreply field has a value.
 */
Query.prototype.hasNoreply = function() {
  return this.has$Value(4);
};


/**
 * @return {number} The number of values in the noreply field.
 */
Query.prototype.noreplyCount = function() {
  return this.count$Values(4);
};


/**
 * Clears the values in the noreply field.
 */
Query.prototype.clearNoreply = function() {
  this.clear$Field(4);
};
...
TermBase = (function() {
  ...
  TermBase.prototype.run = function(conn, cb) {
    var key, useOutdated;
    useOutdated = void 0;
    if (typeof conn === 'object' && !(conn instanceof Connection)) {
      useOutdated = !!conn.useOutdated;
      for (key in conn) {
        if (!__hasProp.call(conn, key)) continue;
        if (key !== 'connection' && key !== 'useOutdated') {
    ...
    return conn._start(this, cb, useOutdated);
  };
...
RDBVal = (function(_super) {
  ...
  RDBVal.prototype.mod = function(other) {
  ...
  RDBVal.prototype.between = ar(function(left, right) {
    return new Between({
      leftBound: (left != null ? left : void 0),
      rightBound: (right != null ? right : void 0)
    }, this);
  });
  ...
  RDBVal.prototype.eqJoin = ar(function(left_attr, right) {
    return new EqJoin({}, this, left_attr, right);
  });
  ...
  RDBVal.prototype.groupBy = function() {
    var arg_count, attrs, collector, _i;
...
DatumTerm = (function(_super) {
  ...
  DatumTerm.deconstruct = function(datum) {
    var dt, obj, pair, _i, _j, _len, _len1, _ref, _ref1, _results;
    switch (datum.getType()) {
      ...
      case Datum.DatumType.R_ARRAY:
        _ref = datum.rArrayArray();
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          dt = _ref[_i];
          _results.push(DatumTerm.deconstruct(dt));
        }
        return _results;
        break;
      case Datum.DatumType.R_OBJECT:
        obj = {};
        _ref1 = datum.rObjectArray();
...
GetAttr = (function(_super) {
  ...
  function GetAttr() {
    return GetAttr.__super__.constructor.apply(this, arguments);
  }
...
rethinkdb.js = ar(function(jssrc) {
  return new JavaScript({}, jssrc);
});
...
Connection = (function() {
  ...
  Connection.prototype.DEFAULT_DB = 'test';
  ...
  function Connection(host, callback) {
    ...
    this.db = new Db({}, host.db || this.DEFAULT_DB);
  ...
  mkAtom = function(response) {
    return DatumTerm.deconstruct(response.getResponse(0));
  };
  ...
  mkSeq = function(response) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      res = _ref[_i];
      _results.push(DatumTerm.deconstruct(res));
    }
    return _results;
  };
  ...
  Connection.prototype.use = ar(function(db) {
    return this.db = new Db({}, db);
  });

  Connection.prototype._start = function(term, cb, useOutdated) {
...
rethinkdb.connect = function(host, callback) {
...
rethinkdb.embeddedConnect = function(callback) {
  if (callback == null) {
    callback = (function() {});
  }
